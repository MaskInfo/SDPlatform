 ...
 */
public class QiniuMaterialUtil {

    private static final Logger LOGGER = LoggerFactory.getLogger(QiniuMaterialUtil.class);
    ...
    public static String UP_HOST = "http://enernet.mobi/";
    //空间名
    private static String BUCKET = "hbny";
    ...
    public static String upLoadToQiNiu(HttpServletRequest request, MultipartFile file) {
        try {
            ...
            if (StringUtils.isNotBlank(originalFilename)) {
                ...
                boolean upload = QiniuMaterialUtil.upload(BUCKET, key, localFile);
                //查看是否上传成功
...
//				resource.setLength(file.getSize());
    ...
    public static String upLoadToQiNiu(MultipartHttpServletRequest request) {
        try {
            ...
            //将图片上传到七牛
            String key = hashPath + fileName;
            boolean upload = QiniuMaterialUtil.upload(BUCKET, key, inputStream);
            //查看是否上传成功
